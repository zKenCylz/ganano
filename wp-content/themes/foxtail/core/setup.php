...
function foxtail_widgets_init()
{
    ...
    register_sidebar(array(
        'name' => __('Top Left Sidebar', 'foxtail'),
        'id' => 'sidebar-top-left',
        'description' => '',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
	...
	register_sidebar(array(
		'name' => __('Top Right Sidebar', 'foxtail'),
    ...
    register_sidebar(array(
        'name' => __('Footer Sidebar Socials', 'foxtail'),
        'id' => 'sidebar-footer-socials',
        'description' => '',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '',
...
function foxtail_styles()
{
    ...
    wp_enqueue_style('owl-carousel-style', get_template_directory_uri() . '/css/owl.carousel.min.css', array());
    wp_enqueue_style('owl-carousel-theme-style', get_template_directory_uri() . '/css/owl.theme.default.min.css', array());
    wp_enqueue_style('custom-style', get_template_directory_uri() . '/css/bootstrap.css', array());
